                        ...
                        <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8">
                            <div>
                                <div class="mb-6 flex justify-end">
                                    <a href="/admin/rental/add" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300">Add category</a>
                                </div>
                            </div>
