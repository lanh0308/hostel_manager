            ...
            <div class="w-full px-10 py-5 flex justify-center items-center min-h-screen">
                <form style="width: 500px" id="form-edit">
                    ...
                    <div class="mb-6">
                        ...
                        <input required type="number" id="floor_number" name="floor_number" value="<%=roomCategory.getFloor_number()%>"  class="bg-gray-50 border border-pink-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5">
                    </div>
