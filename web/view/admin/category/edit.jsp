        ...
        <div class="flex">
            ...
            <div class="w-full px-10 py-5 flex justify-center items-center min-h-screen">
                <form style="width: 500px" id="form-edit" class="border border-gray-500 rounded-lg p-10">
                    ...
                    <input id="id" name="id" value="<%=roomCategory.getID()%>" type="hidden"/>
                    <div class="mb-6">
                        ...
                        <select id="bedCategory" name="bedCategory" class="bg-gray-50 border border-pink-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5">
                            <c:forEach items="${bedCategorys}" var="bedCategory">
                                <c:choose>
                                    <c:when test="${roomCategory.getBed_category().getId()==bedCategory.getId()}">
                                        <option value="${bedCategory.getId()}" selected>${bedCategory.getName()}</option>
                                    </c:when>    
                                    <c:otherwise>
                    ...
                    <div class="mb-6">
                        ...
                        <input required type="text" id="name" name="name" value="<%=roomCategory.getName()%>"  class="bg-gray-50 border border-pink-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5">
                    </div>
                    <div class="mb-6">
                        <label for="unit_price" class="block mb-2 text-sm font-medium text-gray-900">Price</label>
                        <input required type="number" id="unit_price" name="unit_price" value="<%=roomCategory.getUnit_price()%>"  class="bg-gray-50 border border-pink-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5">
                    </div>
                    <div class="mb-6">
                        <label for="areage" class="block mb-2 text-sm font-medium text-gray-900">Areage</label>
                        <input required type="number" id="areage" name="areage" value="<%=roomCategory.getAreage()%>"  class="bg-gray-50 border border-pink-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5">
                    </div>
                    <div class="mb-6">
                        <label for="desk_number" class="block mb-2 text-sm font-medium text-gray-900">Desk number</label>
                        <input required type="number" id="desk_number" name="desk_number" value="<%=roomCategory.getDesk_number()%>"  class="bg-gray-50 border border-pink-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5">
                    </div>
                    <div class="mb-6">
                        <label for="floor_number" class="block mb-2 text-sm font-medium text-gray-900">Floor number</label>
                        <input disabled type="number" id="floor_number" name="floor_number" value="<%=roomCategory.getFloor_number()%>"  class="bg-gray-50 border border-pink-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5">
                    </div>
                    <div class="flex space-x-4">
                        <div class="flex items-center mb-6">
                            <input id="is_window" value="true" name="is_window" aria-describedby="is_window" type="checkbox" class="w-4 h-4 text-pink-600 bg-pink-100 rounded border-pink-300 focus:ring-pink-500" <%=roomCategory.isIs_window() ? "checked" : ""%>>
                            <label for="is_window" class="ml-3 text-sm font-medium text-gray-900">window</label>
                        </div>
                        <div class="flex items-center mb-6">
                            <input id="is_balcony" value="true" name="is_balcony" aria-describedby="is_balcony" type="checkbox" class="w-4 h-4 text-pink-600 bg-pink-100 rounded border-pink-300 focus:ring-pink-500" <%=roomCategory.isIs_balcony() ? "checked" : ""%>>
                            <label for="is_balcony" class="ml-3 text-sm font-medium text-gray-900">balcony</label>
                        </div>
                        <div class="flex items-center mb-6">
                            <input id="is_kitchen" value="true" name="is_kitchen" aria-describedby="is_kitchen" type="checkbox" class="w-4 h-4 text-pink-600 bg-pink-100 rounded border-pink-300 focus:ring-pink-500" <%=roomCategory.isIs_kitchen() ? "checked" : ""%>>
