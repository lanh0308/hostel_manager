            ...
            <div class="w-full px-10 py-5">
                <div class="flex justify-center items-center" style="height: 80vh">
                    <form style="width: 500px" id="form-status-edit" action="/admin/room/changepass" method="post" class="border border-gray-500 rounded-lg p-10">
                        ...
                        <button type="submit" class="text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Change</button>
                    </form>
                </div>
            </div>
        </div>
